...
public class EgovProperties {
	 ...
	 * @return String
	 */
	public static String getPropertiesProperty(String propertiesName, String keyName) {
		String value = "";

		LOGGER.debug("getPathProperty : {} = {}", RELATIVE_PATH_PREFIX + "props" + FILE_SEPARATOR + propertiesName, keyName);

		FileInputStream fis = null;
		try {
			Properties props = new Properties();

			fis = new FileInputStream(EgovWebUtil.filePathBlackList(RELATIVE_PATH_PREFIX + "props" + FILE_SEPARATOR + propertiesName));
			props.load(new BufferedInputStream(fis));

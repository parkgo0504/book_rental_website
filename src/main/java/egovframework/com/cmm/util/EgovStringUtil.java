...
public class EgovStringUtil {
	 ...
	 * 인자로 받은 String이 null일 경우 &quot;&quot;로 리턴한다.
	 * &#064;param src null값일 가능성이 있는 String 값.
	 * &#064;param str 변경될 String 값.
	 * &#064;return 만약 String이 null 값일 경우 &quot;&quot;로 바꾼 String 값.
	 *</pre>
	 */
	public static String isNullToString(String src, String str) {
	 ...
	 *</pre>
	 */
	public static String isNullToInt(Object src) {
	 ...
	 *</pre>
	 */
	//public static String nullConvert(Object src, String str) {
	//	//if (src != null && src.getClass().getName().equals("java.math.BigDecimal")) {
	//	if (src != null && src instanceof BigDecimal) {
	//		return ((BigDecimal) src).toString();
	//	}
	 ...
	 *</pre>
	 */
	//public static String nullConvert(String src, String str) {
	...
	/**
	 * 현재날짜를 포멧을 전달 받아 출력 한다.
	 *
	 * @param String format
	 * @return String
	 */
	public static long getDateDiffMinute(LocalDateTime selectDateTime) throws ParseException {
		Calendar getToday = Calendar.getInstance();
		getToday.setTime(new Date()); //금일 날짜

		// 2. LocalDateTime -> Date 변환
		Date date = Timestamp.valueOf(selectDateTime);
		Calendar cmpDate = Calendar.getInstance();
		cmpDate.setTime(date); //특정 일자

		long diffSec = (getToday.getTimeInMillis() - cmpDate.getTimeInMillis()) / 1000;
		long diffMinute = diffSec / (60); //일자수 차이
	 ...
	 * @return I or A
	 */
	public static String UserBrowserChk(HttpServletRequest req) {
		...
		if(userAgent.indexOf("Trident") > -1 || userAgent.indexOf("MSIE") > -1) { //IE
			...
			browser = "WHALE " + userAgent.split("Whale/")[1].split(" ")[0];

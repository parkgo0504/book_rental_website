			...
			<div class="container" style="width: 1400px;">
				...
				<div class="notice notice-info">
					...
					<h1 style="color: #353535; font-weight: bold; font-size: 20px;">
						&nbsp;아이디를 찾기 위해 아래에 회원 정보를 입력해주세요.</h1>
					...
					<div class="col-md-12 order-md-1">
						...
						<div class="row"
							...
							<div class="mb-3">
								<label for="real-name">이름 *</label> <input type="text"
									class="form-control" id="real-name" placeholder="" value=""
									required name="user-real-name">
						...
						<div class="row"
							...
							<div class="mb-3">
								<label for="phonenum">연락처 *</label> <input type="tel"
									class="form-control" id="phonenum" placeholder="010-1234-5678"
									required name="user-phonenum">
						...
						<div class="row"
							...
							<button class="btn btn-primary btn-lg btn-block" type="submit"
								...
								onclick="window.open('reg_complete.do')">아이디찾기</button>
							<hr class="mb-4">
						</div>
					</div>
